 ...
 * 32-bit state, fast, good distribution for game use.
 * Note: not equidistributed (~1/3 of uint32 values are unreachable, per the
 * author's own 2022 follow-up). Fine for question shuffling, but don't reach
 * for it where strict uniformity matters.
